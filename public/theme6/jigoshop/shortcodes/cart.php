 ...
 */
function get_my_cart($atts) {
    return jigoshop_shortcode_wrapper('my_cart', $atts);
}
                    ...
                    foreach (jigoshop_cart::$cart_contents as $cart_item_key => $values) :
                        ...
                        if ($_product->exists() && $values['quantity'] > 0) :
                            ...
                            <tr>
                                ...
                                <td class="product-price"><span class="m-label">Unit price:</span><?php echo jigoshop_price($_product->get_price()); ?></td>
                                ...
                                <td class="product-subtotal"><span class="m-label">Price:</span><?php echo jigoshop_price($_product->get_price() * $values['quantity']); ?></td>
                            </tr>
                            <?php
                        endif;
                    endforeach;
