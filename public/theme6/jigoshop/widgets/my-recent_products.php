<?php
// =============================== My Recent Products Widget ======================================
class MY_RecentProducts extends WP_Widget {
    /** constructor */
    function MY_RecentProducts() {
        parent::WP_Widget(false, $name = 'My - Recent Products');	
    }
    ...
    function widget($args, $instance) {		
		...
		<?php 
			$code = '[recent_products per_page="'.$prod_count.'"]';
		?>
