class AdminHomeController <ApplicationController
	...
	def order
		...
		if session[:flag]==false||session[:flag]==nil then 
			...
			@order = Masterusers.find_by_sql("select * from order_#{session[:master_user_id]} where cod_confirm = 'true' ORDER BY order_id DESC")
			...
			@order = Masterusers.find_by_sql("select * from order_#{session[:master_user_id]} where order_status = 'panding' ORDER BY order_id DESC")
